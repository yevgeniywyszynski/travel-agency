...
const Trip = ({error, name, image, cost, days, description, country, countryCode, intro, tripId}) => {
      ...
      <Grid>
        <Row>
          <Col xs={12}>
            ...
            <OrderForm tripName={name} tripCost={cost} tripId={tripId} countryCode={countryCode} />
          </Col>
        </Row>
      </Grid>
      <Grid>
